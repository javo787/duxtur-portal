...
const labels: Record<string, Record<string, string>> = {
  btn: {
    ru: 'Связаться с врачом',
    uz: "Shifokor bilan bog'lanish",
    tg: 'Бо духтур тамос гирифтан',
    kk: 'Дәрігермен байланысу',
    ky: 'Дарыгер менен байланышуу',
  },
  phone: {
    ru: 'Телефон',
    uz: 'Telefon',
  ...
  noContact: {
    ru: 'Контакты не указаны',
    uz: "Aloqa ma'lumotlari yo'q",
    tg: 'Маълумоти тамос нест',
    kk: 'Байланыс жоқ',
    ky: 'Байланыш жок',
  },
};

const t = (key: string, lang: string): string => labels[key]?.[lang] || labels[key]?.ru || '';
            ...
            <div className="text-center mb-6">
              ...
              {doctor.workingHours && (
                <p className="text-xs text-gray-400 mt-1 flex items-center justify-center gap-1">
                  ...
                  {t('hours', lang)}: {doctor.workingHours}
                </p>
              )}
            </div>

            {!hasContacts ? (
              <p className="text-center text-gray-400 text-sm py-4">{t('noContact', lang)}</p>
            ) : (
              <div className="space-y-2.5">
                ...
                {doctor.phone && (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs text-gray-400 font-medium">{t('phone', lang)}</p>
                      <p className="font-bold text-gray-900 truncate">{doctor.phone}</p>
                    </div>
                    <svg
                      className="w-4 h-4 text-gray-300 group-hover:text-blue-400 transition shrink-0"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                {doctor.whatsapp && (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="font-bold text-gray-900">{t('write', lang)}</p>
                    </div>
                    <svg
                      className="w-4 h-4 text-gray-300 group-hover:text-green-500 transition shrink-0"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                {doctor.telegram && (
                  ...
                  >
                    ...
                    <svg
                      className="w-4 h-4 text-gray-300 group-hover:text-sky-400 transition shrink-0"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                {doctor.instagram && (
                  ...
                  >
                    ...
                    <svg
                      className="w-4 h-4 text-gray-300 group-hover:text-pink-400 transition shrink-0"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
