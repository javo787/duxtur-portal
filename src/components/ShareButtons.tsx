  ...
  return (
    <div className="flex items-center gap-3 flex-wrap">
      ...
      <a href={`https://t.me/share/url?url=${encoded}&text=${encodedTitle}`}
        ...
        className="flex items-center gap-2 px-4 py-2 bg-[#229ED9] hover:bg-[#1a8bbf] text-white rounded-xl font-bold text-sm transition shadow-sm">
      ...
      <a href={`https://wa.me/?text=${encodedTitle}%20${encoded}`}
        target="_blank" rel="noopener noreferrer"
        className="flex items-center gap-2 px-4 py-2 bg-[#25D366] hover:bg-[#1db954] text-white rounded-xl font-bold text-sm transition shadow-sm">
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <button onClick={copyLink}
        className={`flex items-center gap-2 px-4 py-2 rounded-xl font-bold text-sm transition shadow-sm border ${
          copied
