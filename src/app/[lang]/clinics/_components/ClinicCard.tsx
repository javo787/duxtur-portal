    ...
    >
      ...
      >
        ...
        <div className={cn(
          ...
          {/* Logo Overlay */}
          <div className="absolute bottom-4 left-4 w-12 h-12 bg-white dark:bg-slate-800 rounded-2xl p-1.5 shadow-xl group-hover:scale-110 transition-transform duration-500">
