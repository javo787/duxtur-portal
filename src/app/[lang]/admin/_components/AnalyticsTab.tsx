    ...
    <div className="space-y-6">
       <div className="bg-white p-6 rounded-2xl border shadow-sm">
          ...
          <div className="h-24 w-full flex items-end gap-1">
             {[...Array(30)].map((_, i) => (
               <div key={i} className="flex-1 bg-blue-100 rounded-t-sm hover:bg-blue-500 transition-colors" style={{ height: `${Math.random() * 100}%` }} title={`День ${i+1}`} />
             ))}
          </div>
       </div>
       ...
       <div className="bg-white rounded-2xl border p-6">
          <h3 className="font-black text-slate-900 mb-4">Популярные статьи</h3>
