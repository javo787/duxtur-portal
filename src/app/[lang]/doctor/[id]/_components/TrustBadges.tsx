...
export default function TrustBadges({ lastMedicalReviewDate, lastArticleDate, lang, licenseNumber }: TrustBadgesProps) {
  const { t } = useT(lang);
      ...
      <div className="p-5 space-y-4">
        ...
        {licenseNumber && (
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-bold text-gray-800 text-sm">{t('doctor.licenseNumber')}</p>
              <p className="text-gray-400 text-xs mt-0.5">{licenseNumber}</p>
            </div>
          </div>
        )}
      </div>
